...
import com.ypz.killetom.basedevsdk.tools.file.KTFileTools
import java.io.File

class KTIntentHelperTools private constructor() {
    ...
    fun getInstallAppIntent(context: Context, filePath: String): Intent? {
        ...
        val contentUri = KTFileTools.instant.getUriForFile(context, apkfile)
    ...
    companion object {
        ...
        val instantce by lazy { KTIntentHelperTools() }
    }
}