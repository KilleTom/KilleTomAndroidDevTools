...
import com.ypz.killetom.basedevsdk.constant.DataConstatns.SPACE
import com.ypz.killetom.basedevsdk.constant.MemoryRadioConstant.BYTE
import com.ypz.killetom.basedevsdk.constant.MemoryRadioConstant.GB
import com.ypz.killetom.basedevsdk.constant.MemoryRadioConstant.KB
import com.ypz.killetom.basedevsdk.constant.MemoryRadioConstant.MB
import com.ypz.killetom.basedevsdk.unit.MemoryUnit
import java.io.*
...
class KTDataTools private constructor(){
    ...
    fun size2Byte(size: Long, unit: MemoryUnit = MemoryUnit.BYTE): Long {
        return if (size < 0) {
            -1
        } else when (unit) {
    ...
    fun input2OutputStream(inputStream: InputStream?): ByteArrayOutputStream? {
        ...
        try {
            ...
            ins.use {
                ...
                while (ins.read(b,0, KB).also { len = it } !=-1){
    ...
    companion object{
        val instants by lazy { KTDataTools() }
    }
}
