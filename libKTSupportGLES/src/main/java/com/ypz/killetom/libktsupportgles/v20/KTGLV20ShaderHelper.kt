...
import com.ypz.killetom.libktsupportgles.BuildConfig


class KTGLV20ShaderHelper private constructor() :
    com.ypz.killetom.libktsupportgles.KTGlShaderHelper {

    override var openLog: Boolean = BuildConfig.DEBUG
    ...
    companion object {
        val instant by lazy { KTGLV20ShaderHelper() }
        val newInstant by lazy { KTGLV20ShaderHelper() }
    }
}